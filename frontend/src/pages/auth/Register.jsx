...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#0b1326] text-[#dae2fd] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg bg-[#171f33]/90 border border-[#2d3449] rounded-2xl p-8 shadow-2xl backdrop-blur-xl relative z-10 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-[#908fa0]">Get started with RAG vector knowledge models</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className={`p-3.5 rounded-xl border text-left transition-all ${
              role === 'business'
                ...
                : 'bg-[#131b2e] border-[#2d3449] text-[#908fa0] hover:text-white'
            }`}
          >
            ...
            <p className="text-[10px] text-[#908fa0] mt-0.5">Widget studio & lead analytics</p>
          </button>
          ...
          >
            ...
            <p className="text-[10px] text-[#908fa0] mt-0.5">REST API, Webhooks & SDKs</p>
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-[#c7c4d7]">Full Name</label>
              <input
                type="text"
                required
                value={formData.name}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-[#c7c4d7]">Company / App Name</label>
              <input
                type="text"
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-[#c7c4d7]">Work Email Address</label>
            <input
              type="email"
              required
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-[#131b2e] text-white text-xs sm:text-sm px-3.5 py-2.5 rounded-xl border border-[#2d3449] focus:outline-none focus:border-[#6366f1]"
            />
            <p className="text-[11px] text-[#908fa0]">Must be 8+ chars with uppercase, lowercase, number & special char (!@#$)</p>
            {formData.password && (
              <div className="space-y-1 pt-1">
                <div className="h-1.5 w-full bg-[#131b2e] rounded-full overflow-hidden">
                  <div className={`h-full ${strength.color} transition-all duration-300`} style={{ width: strength.width }} />
                </div>
                <p className="text-[10px] text-[#908fa0] text-right font-mono">{strength.label}</p>
              </div>
            )}
          </div>

          <div className="flex items-center gap-2 text-xs text-[#908fa0]">
            <input type="checkbox" required id="tos" className="rounded bg-[#131b2e] border-[#2d3449] text-[#6366f1]" />
            <label htmlFor="tos">
