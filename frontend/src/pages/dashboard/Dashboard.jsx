      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 md:p-8 space-y-8 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {/* Metric 1 */}
            <div className="bg-[#171f33] border border-[#2d3449] rounded-2xl p-5 space-y-3 relative overflow-hidden group hover:border-[#6366f1]/50 transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium text-[#908fa0]">Active Chatbots</span>
              ...
              <p className="text-[11px] text-[#908fa0]">Across production environments</p>
            </div>

            {/* Metric 2 */}
            <div className="bg-[#171f33] border border-[#2d3449] rounded-2xl p-5 space-y-3 relative overflow-hidden group hover:border-[#38bdf8]/50 transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium text-[#908fa0]">Total Messages</span>
              ...
              <p className="text-[11px] text-[#908fa0]">This monthly billing cycle</p>
            </div>

            {/* Metric 3 */}
            <div className="bg-[#171f33] border border-[#2d3449] rounded-2xl p-5 space-y-3 relative overflow-hidden group hover:border-[#10b981]/50 transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium text-[#908fa0]">Knowledge Docs</span>
              ...
              <p className="text-[11px] text-[#908fa0]">Vector embeddings synchronized</p>
            </div>

            {/* Metric 4 */}
            <div className="bg-[#171f33] border border-[#2d3449] rounded-2xl p-5 space-y-3 relative overflow-hidden group hover:border-amber-500/50 transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium text-[#908fa0]">API Rate Limit Usage</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 bg-[#171f33] border border-[#2d3449] rounded-2xl p-6 space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#2d3449] pb-4">
                <div>
                  <h2 className="text-base font-bold text-white">Message Volume & RAG Resolution Speed</h2>
                  <p className="text-xs text-[#908fa0]">Real-time AI query resolution breakdown over 24 hours</p>
                </div>
                <div className="flex items-center gap-2">
                  <span className="w-3 h-3 rounded-full bg-[#6366f1]" />
                  <span className="text-xs text-[#c7c4d7]">Queries</span>
                </div>
              </div>
            ...
            <div className="lg:col-span-4 bg-[#171f33] border border-[#2d3449] rounded-2xl p-6 space-y-4 flex flex-col justify-between">
              <div className="border-b border-[#2d3449] pb-3">
                <h2 className="text-base font-bold text-white">Customer Intent Distribution</h2>
                <p className="text-xs text-[#908fa0]">Top query topics categorized by RAG engine</p>
              </div>
              ...
              <div className="space-y-2 pt-2 border-t border-[#2d3449]">
          ...
          <div className="bg-[#171f33] border border-[#2d3449] rounded-2xl p-6 space-y-4">
            <div className="flex items-center justify-between border-b border-[#2d3449] pb-4">
              <div>
                ...
                <p className="text-xs text-[#908fa0]">Recent interactions handled by the AI support agent</p>
              </div>
                ...
                <tbody className="divide-y divide-[#2d3449]/30 text-[#dae2fd]">
                  {recentConversations.map((row, idx) => (
                    <tr key={idx} className="hover:bg-[#222a3d]/40 transition-colors">
                      ...
                      <td className="py-3.5 text-[#c7c4d7]">{row.topic}</td>
                      <td className="py-3.5 font-mono text-[#10b981]">{row.score}</td>
                      <td className="py-3.5 text-[#908fa0]">{row.time}</td>
